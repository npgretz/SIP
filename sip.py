...
def parse_options():
    ...
    below, except with less Elvis. It will also find files directly in the
    subject directory, as well as files with names ending in "_QC.csv",
    ...
    - ActiGraph data in 1-second epochs, as generated by the ActiLife
      ...
      Example file name: "Elvis/ActiGraph/Elvis_1secDataTable.csv"

      Set this with "--ag-path your_path_here.csv".
    ...
    - activPAL data, as generated by the activPAL software. These consist of
      ...
      Example file names: "Elvis/activPAL/Elvis Events.csv" and
                          "Elvis/activPAL/Elvis.def"

      Note that these file names must have the *exact* same stem (here
      "Elvis").

      Set this with "--ap-path your_path_here.csv"
    ...
    - Awake ranges data, indicating when the subject was wearing the
      ...
      Example file name: "Elvis/ActiGraph/Elvis_awake ranges.csv"
    ...
    - Sojourns/SIP annotated data, indicating bout boundaries and second-by-
      ...
      Example file name: "Elvis/ActiGraph/Elvis_1secDataTable_sojourns.csv"

      Set this with "--awake-path your_path_here.csv", or ignore an existing
      awake ranges file with "--ignore-awake-ranges".
    ...
    - Sojourns/SIP processed data, containing loads of summary measures
      ...
      Example file name: "Elvis/ActiGraph/Elvis_1secDataTable_sojourns_processed.csv"
    ...
    parser.add_option('-s', '--subject', dest='subj',
                      help='Subject identifier (you can ignore this)')
    ...
    parser.add_option('--soj-path', type='path',
                      help='Path to sojourns preprocessed ActiGraph data, or '
                           'output path for same')
    ...
    parser.add_option('--soj-intermediate-path', type='path',
                      help='Path to write intermediate sojourns data. This '
                           'is a quick hack.')
